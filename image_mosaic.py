...
if __name__ == '__main__':
    ...
    try:
        ...
        print e
        sys.exit(1)
    basef, extf = splitext(args.image_path)
    ...
    # This then informs a new final poster size
    # poster_width = prints_wide * _PRINT_WIDTH * _PRINT_DPI
    # poster_height = prints_high * _PRINT_HEIGHT * _PRINT_DPI
